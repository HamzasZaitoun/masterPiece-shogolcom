                    ...
                    <tr>
                        ...
                        <td class="action">
                            <div class="flex">
                                ...
                                <a href="{{ route('admin.categories.showCategory', ['id' => $category->category_id]) }}"
                                ...
                                <form id="deleteCategoryForm"
                                    action="{{ route('admin.categories.deleteCategory', ['id' => $category->category_id]) }}"
                                    method="POST" id="deleteCategoryForm" class="d-inline">
                                    @csrf
                                    @Method('DELETE')
